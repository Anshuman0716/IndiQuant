...
def test_universe_is_survivorship_free(tmp_lakehouse: Lakehouse) -> None:
    ...
    _write_mock_membership(
        tmp_lakehouse,
        [
            {"index_name": "NIFTY 500", "isin": "INE_LIVE1", "valid_from": "2015-01-01", "valid_to": None},
            {"index_name": "NIFTY 500", "isin": "INE_LIVE2", "valid_from": "2015-01-01", "valid_to": None},
            {"index_name": "NIFTY 500", "isin": "INE_DEAD1", "valid_from": "2010-01-01", "valid_to": "2018-01-01"},
            {"index_name": "NIFTY 500", "isin": "INE_DEAD2", "valid_from": "2012-01-01", "valid_to": "2017-01-01"},
            {"index_name": "NIFTY 500", "isin": "INE_DEAD3", "valid_from": "2014-01-01", "valid_to": "2019-01-01"},
        ]
    )
    ...
    for d in dates:
        for isin in ["INE_LIVE1", "INE_LIVE2", "INE_DEAD1", "INE_DEAD2", "INE_DEAD3"]:
            prices.append({
                "isin": isin, "date": d.strftime("%Y-%m-%d"), 
